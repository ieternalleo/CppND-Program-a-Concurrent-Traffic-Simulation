...
void TrafficLight::cycleThroughPhases()
{
    ...
    // and toggles the current phase of the traffic light between red and green and 
    ...
    std::mt19937 mt(rd());
    std::uniform_int_distribution<int> rng(4,6); // range is between 4 and 6
    int random_number;
    ...
    while(true)
    {
        ...
        random_number = rng(mt);
    

        elapsed_time = end_time - start_time;
        if(round(elapsed_time.count()) >= random_number)
        {
